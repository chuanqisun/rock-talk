...
RockTalk is designed as a community reflection ritual. It takes practices from constructive community work, like shared questions, mutual accountability, and care that accrues over time, and turns them into a format people can do alone without leaving the group behind.
...
During a session, the rock guides a short voice reflection that stays with the round topic. That constraint matters. It lowers the pressure to perform. It helps people avoid spiraling into open ended life advice. It also supports the steady tempo of good facilitation: a question, a pause, then a return to the shared frame. In our pilot, the rock often begins by placing the participant inside a collective field of attention before turning inward: “I hear you. That restlessness is something others have shared too, especially when facing the cold. Can you tell me more about where you're noticing that feeling in your body?” This kind of phrasing is deliberate. It gives the solitude of a personal session the faint but unmistakable pressure of community, a reminder that the question is being held by more than one person.

Afterward, participants can review what was captured and, if they choose, contribute a few anonymized memories back to the round. These memories are gifts to future participants. They are brief traces of themes, emotions, and turning points that protect privacy while still offering companionship. As a round grows, it becomes a palimpsest. The rock can respond to what has accumulated by speaking in patterns rather than quotations. It can say, in effect, that others have been here too, without exposing anyone’s story.

RockTalk also includes a moderator role. The moderator curates rocks and rounds, then periodically synthesizes themes from the memories. This creates a path from private reflection to shared discussion. It mirrors constructive community practice where individual sense making becomes material for collective care. The rocks are also designed to meet the full range of human moments with composure. In the pilot, when a participant expressed embarrassment about a bodily interruption, the system replied, “That’s completely natural. Let’s welcome that release as part of the body processing the experience.” The aim is not to make AI into a confidant that replaces real relationships. It is to use AI as a mediator with structure and restraint, one that helps a group hold questions together, patiently, across time.

```mermaid
flowchart TD
    %% RockTalk interaction flow (high-level)

    M[Community Moderator] -->|Invite seed member| S[Seed Community Member]
    S -->|Create a Rock practice + values| R["Rock Teacher"]
    M -->|Choose a shared topic| T[Round Topic]
    T -->|Create Round| RD[Round]

    R -->|Generate unique link| U[Unique Rock URL]
    RD -->|Context for sessions| U

    U -->|Share link| CM[Community Members]
    CM -->|Open link & do session| SES[Guided Reflection Session]
    SES -->|Submit anonymized traces| AM[Anonymized Memories]
    AM -->|Stored by Rock + Round| MEM[Community Memory Pool]

    MEM -->|Informs future sessions| R

    M -->|When community gathers| G[Live Group Discussion]
    MEM -->|Synthesize themes/insights| SYN[Moderator Synthesis]
    SYN --> G
